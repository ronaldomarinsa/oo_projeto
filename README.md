...
- Você também terá a opção de criar clientes que utilizam endereço específico de cobrança, nesse caso, crie uma interface para que esses tipos de clientes possam implementar.
